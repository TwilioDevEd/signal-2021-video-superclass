 ...
 */ !(function (e) {
    ...
    function f(e, t) {
      try {
        ...
        if (t && ("object" == typeof t || "function" == typeof t)) {
          var r = t.then;
          if (t instanceof u) return (e._state = 3), (e._value = t), void h(e);
  ...
  function (e, t, r) {
    ...
    function n(e) {
      if (
        ("performance" in e || (e.performance = {}), !("now" in e.performance))
      ) {
        var t = Date.now();
        e.performance = {
          now: function () {
    ...
    r.r(t),
      r.d(t, "_testExports", function () {
        return o;
      }),
      n(self);
    var o = { polyfillPerformance: n };
  },
  function (e, t, r) {
    "use strict";
    r.r(t),
        ...
        var r,
          n =
            ...
            function (t) {
              ...
              function v(e) {
                v.shown || (v.shown = {}),
                  v.shown[e] || ((v.shown[e] = 1), p(e));
              }
              (a = null),
                t.arguments && (u = t.arguments),
                t.thisProgram && (c = t.thisProgram),
                t.quit && t.quit,
              ...
              function g(e, t, r) {
                ...
                if (o - t > 16 && e.subarray && m)
                  return m.decode(e.subarray(t, o));
                for (var i = ""; t < o; ) {
                  var a = e[t++];
                  if (128 & a) {
                    var s = 63 & e[t++];
              ...
              var _,
                ...
                D =
                  "undefined" != typeof TextDecoder
                    ...
                    : void 0;
              function M(e, t) {
                for (var r = e, n = r >> 1, o = n + t / 2; !(n >= o) && A[n]; )
                  ++n;
                if ((r = n << 1) - e > 32 && D)
                  return D.decode(C.subarray(e, r));
              ...
              function j(e) {
                var t = E(e) + 1,
                  r = Ht(t);
                return r && w(e, T, r, t), r;
              }
              function U(e) {
                (_ = e),
                  (t.HEAP8 = T = new Int8Array(e)),
                  (t.HEAP16 = S = new Int16Array(e)),
                  (t.HEAP32 = k = new Int32Array(e)),
                  (t.HEAPU8 = C = new Uint8Array(e)),
                  (t.HEAPU16 = A = new Uint16Array(e)),
              ...
              var X,
                Q = "amazon-ivs-wasmworker.min.wasm";
              function Z(e) {
                try {
              ...
              K(Q) ||
                ((X = Q), (Q = t.locateFile ? t.locateFile(X, f) : f + X));
              var te = 0,
                re = 4,
                ne = 8,
                oe = 12,
              ...
              function se(e) {
                (this.excPtr = e),
                  ...
                  (this.get_type = function () {
                    return k[(this.ptr + ne) >> 2];
                  }),
                  (this.set_destructor = function (e) {
                    k[(this.ptr + te) >> 2] = e;
                  }),
                  (this.get_destructor = function () {
                    return k[(this.ptr + te) >> 2];
                  }),
                  (this.set_refcount = function (e) {
                    k[(this.ptr + re) >> 2] = e;
                  }),
                  (this.set_caught = function (e) {
                    (e = e ? 1 : 0), (T[(this.ptr + oe) >> 0] = e);
                  }),
                  (this.get_caught = function () {
                    return 0 != T[(this.ptr + oe) >> 0];
                  }),
                  (this.set_rethrown = function (e) {
                    (e = e ? 1 : 0), (T[(this.ptr + ie) >> 0] = e);
                  }),
                  (this.get_rethrown = function () {
                    return 0 != T[(this.ptr + ie) >> 0];
                  }),
                  ...
                  (this.add_ref = function () {
                    var e = k[(this.ptr + re) >> 2];
                    k[(this.ptr + re) >> 2] = e + 1;
                  }),
                  (this.release_ref = function () {
                    var e = k[(this.ptr + re) >> 2];
                    return (k[(this.ptr + re) >> 2] = e - 1), 1 === e;
                  });
              }
              function ue(e, t) {
                var r = new Date(1e3 * k[e >> 2]);
                (k[t >> 2] = r.getUTCSeconds()),
                  (k[(t + 4) >> 2] = r.getUTCMinutes()),
                  (k[(t + 8) >> 2] = r.getUTCHours()),
                  (k[(t + 12) >> 2] = r.getUTCDate()),
                  (k[(t + 16) >> 2] = r.getUTCMonth()),
                  (k[(t + 20) >> 2] = r.getUTCFullYear() - 1900),
                ...
                return (
                  (k[(t + 28) >> 2] = o),
                  ue.GMTString || (ue.GMTString = j("GMT")),
                  (k[(t + 40) >> 2] = ue.GMTString),
                  t
                );
              }
              function ce() {
              ...
              function Ee(e, t, r) {
                function n(t) {
                  var n = r(t);
                  n.length !== e.length &&
                    we("Mismatched type converter count");
                  for (var o = 0; o < e.length; ++o) ke(e[o], n[o]);
                }
              ...
              function ke(e, t, r) {
                ...
                if (
                  ...
                  Ae("Cannot register type '" + n + "' twice");
                }
                if (((pe[e] = t), delete ve[e], de.hasOwnProperty(e))) {
                  var o = de[e];
                  delete de[e],
              ...
              function Pe(e) {
                if (!(this instanceof We)) return !1;
              ...
              function $e(e) {
                return "undefined" == typeof FinalizationGroup
                  ? (($e = function (e) {
                    ...
                    e)
                  : ((Oe = new FinalizationGroup(function (e) {
              ...
              function Ve(e, t) {
                ...
                t.$$ || Ae('Cannot pass "' + gt(t) + '" as a ' + this.name),
                  t.$$.ptr ||
                    Ae(
                ...
                return Ye(t.$$.ptr, r, this.registeredClass);
              }
              function qe(e, t) {
                var r;
                if (null === t)
                ...
                if (
                  ((r = Ye(t.$$.ptr, n, this.registeredClass)),
                  this.isSmartPointer)
                )
                  switch (
                    (void 0 === t.$$.smartPtr &&
              ...
              function Je() {
                var e = [];
                for (var t in tt) tt.hasOwnProperty(t) && e.push(tt[t]);
                return e;
              }
              function et(e) {
                (Le = e), je.length && Le && Le(Ue);
              }
              var tt = {};
              function rt(e, t) {
                return (
              ...
              function nt(e, t) {
                return (
                  (t.ptrType && t.ptr) ||
                    we("makeClassHandle requires ptr and ptrType"),
                  !!t.smartPtrType != !!t.smartPtr &&
                    we("Both smartPtrType and smartPtr must be specified"),
                  (t.count = { value: 1 }),
              ...
              function ot(e) {
                ...
                var r = rt(this.registeredClass, t);
                if (void 0 !== r) {
                  if (0 === r.$$.count.value)
                ...
                function o() {
                  return this.isSmartPointer
                    ? nt(this.registeredClass.instancePrototype, {
              ...
              function it(e, t, r, n, o, i, a, s, u, c, f) {
                (this.name = e),
                  ...
                  o || void 0 !== t.baseClass
                    ? (this.toWireType = qe)
                    : n
                    ? ((this.toWireType = Ve), (this.destructorFunction = null))
                    : ((this.toWireType = ze),
              ...
              function ft(e, t) {
                ...
                throw (
                  (t.forEach(function e(t) {
                    n[t] ||
                      pe[t] ||
                      (ve[t] ? ve[t].forEach(e) : (r.push(t), (n[t] = !0)));
                  }),
                  new ut(e + ": " + r.map(ct).join([", "])))
                );
              }
              function lt(e, t) {
              ...
              function pt(e) {
                e > 4 &&
                  0 == --dt[e].refcount &&
                  ((dt[e] = void 0), ht.push(e));
              }
              function vt() {
                for (var e = 0, t = 5; t < dt.length; ++t)
                  void 0 !== dt[t] && ++e;
                return e;
              }
              function yt() {
                for (var e = 5; e < dt.length; ++e)
                  if (void 0 !== dt[e]) return dt[e];
                return null;
              }
              function mt(e) {
                switch (e) {
                  ...
                  case !1:
                    return 4;
                  default:
                    var t = ht.length ? ht.pop() : dt.length;
                    return (dt[t] = { refcount: 1, value: e }), t;
                }
              }
              function gt(e) {
              ...
              function Et(e) {
                return (
                  e || Ae("Cannot use deleted val. handle = " + e), dt[e].value
                );
              }
              function _t(e, t) {
                var r = pe[e];
                return void 0 === r && Ae(t + " has unknown type " + ct(e)), r;
              }
              function Tt(e, t) {
                for (var r = new Array(e), n = 0; n < e; ++n)
                  r[n] = _t(k[(t >> 2) + n], "parameter " + n);
                return r;
              }
              var Ct = {};
              function St(e) {
                var t = Ct[e];
                return void 0 === t ? Ce(e) : t;
              }
              var At,
                kt = [];
              function Pt() {
              ...
              function Ot(e) {
                try {
                  return (
                    h.grow((e - _.byteLength + 65535) >>> 16), U(h.buffer), 1
                  );
                } catch (e) {}
              }
              (At = function () {
                  ...
                  24 & e &&
                    ...
                    (t +=
                      ...
                      (function (e) {
                        ...
                        (t = t.slice(o)),
                          32 & e &&
                            v("EM_LOG_DEMANGLE is deprecated; ignoring"),
                          8 & e &&
                        ...
                        for (var f in a) {
                          var l = a[f],
                            ...
                            m = c.exec(l);
                          if (m && 5 == m.length)
                            (h = m[1]), (d = m[2]), (p = m[3]), (y = m[4]);
                          else {
                            if (
                              ((m = s.exec(l)) || (m = u.exec(l)),
                              !(m && m.length >= 4))
                            ) {
                              t += l + "\n";
                              continue;
                            }
                            (h = m[1]), (d = m[2]), (p = m[3]), (y = 0 | m[4]);
                          }
                          var g = !1;
                          if (8 & e) {
                            var b = emscripten_source_map.originalPositionFor({
                              line: p,
                              column: y,
                            });
                            (g = b && b.source) &&
                              (64 & e &&
                                (b.source = b.source.substring(
                                  b.source
                                    .replace(/\\/g, "/")
                                    .lastIndexOf("/") + 1
                                )),
              ...
              var $t = {
                ...
                printChar: function (e, t) {
                  var r = $t.buffers[e];
                  0 === t || 10 === t
                    ? ((1 === e ? d : p)(g(r, 0)), (r.length = 0))
                    : r.push(t);
                },
                varargs: void 0,
                get: function () {
                  return ($t.varargs += 4), k[($t.varargs - 4) >> 2];
                },
                getStr: function (e) {
                  return b(e);
                },
              ...
              function Ut(e, t, r, n) {
                ...
                function v(e) {
                  var t = jt(new Date(e.tm_year + 1900, 0, 1), e.tm_yday),
                ...
                var y = {
                  ...
                  "%j": function (e) {
                    return h(
                      e.tm_mday +
                        It(xt(e.tm_year + 1900) ? Nt : Lt, e.tm_mon - 1),
                      3
                    );
                  },
                  "%m": function (e) {
                  ...
                  "%U": function (e) {
                    var t = new Date(e.tm_year + 1900, 0, 1),
                      r = 0 === t.getDay() ? t : jt(t, 7 - t.getDay()),
                      n = new Date(e.tm_year + 1900, e.tm_mon, e.tm_mday);
                    if (d(r, n) < 0) {
                      var o =
                          It(xt(n.getFullYear()) ? Nt : Lt, n.getMonth() - 1) -
                          31,
                        i = 31 - r.getDate() + o + n.getDate();
                      return h(Math.ceil(i / 7), 2);
                    }
                    return 0 === d(r, t) ? "01" : "00";
                  },
                  "%V": function (e) {
                    var t,
                      ...
                      o = p(r),
                      i = p(n),
                      a = jt(new Date(e.tm_year + 1900, 0, 1), e.tm_yday);
                    return d(a, o) < 0
                      ? "53"
                      : d(i, a) <= 0
                      ? "01"
                  ...
                  "%W": function (e) {
                    var t = new Date(e.tm_year, 0, 1),
                      r =
                        1 === t.getDay()
                          ? t
                          : jt(t, 0 === t.getDay() ? 1 : 7 - t.getDay() + 1),
                      n = new Date(e.tm_year + 1900, e.tm_mon, e.tm_mday);
                    if (d(r, n) < 0) {
                      var o =
                          It(xt(n.getFullYear()) ? Nt : Lt, n.getMonth() - 1) -
              ...
              (be = t.InternalError = ge(Error, "InternalError")),
                (function () {
                  for (var e = new Array(256), t = 0; t < 256; ++t)
                    e[t] = String.fromCharCode(t);
                  Te = e;
                })(),
                (Se = t.BindingError = ge(Error, "BindingError")),
                (We.prototype.isAliasOf = Pe),
                (We.prototype.clone = xe),
                (We.prototype.delete = Ie),
                (We.prototype.isDeleted = Ne),
                (We.prototype.deleteLater = Fe),
                (it.prototype.getPointee = Ke),
                (it.prototype.destructor = Xe),
                (it.prototype.argPackAdvance = 8),
                (it.prototype.readValueFromPointer = he),
                (it.prototype.deleteObject = Qe),
                (it.prototype.fromWireType = ot),
                (t.getInheritedInstanceCount = Ze),
                (t.getLiveInheritedInstances = Je),
                (t.flushPendingDeletes = Ue),
                (t.setDelayFunction = et),
                (ut = t.UnboundTypeError = ge(Error, "UnboundTypeError")),
                (t.count_emval_handles = vt),
                (t.get_first_emval = yt);
              var Ft,
                Wt = {
                  z: function (e) {
                    return Ht(e + ae) + ae;
                  ...
                  Q: function (e, t) {
                    return (function (e, t) {
                      ...
                      (k[(t + 28) >> 2] = o),
                        (k[(t + 36) >> 2] = -60 * r.getTimezoneOffset());
                      var i = new Date(
                          r.getFullYear(),
                          6,
                          1
                        ...
                        s =
                          0 |
                          (i != a && r.getTimezoneOffset() == Math.min(a, i));
                      k[(t + 32) >> 2] = s;
                      var u = k[(qt() + (s ? 4 : 0)) >> 2];
                      return (k[(t + 40) >> 2] = u), t;
                    })(e, t);
                  ...
                  p: function (e, r, n, o, i, a, s, u, c, f, l, h, d) {
                    (l = Ce(l)),
                      (a = st(i, a)),
                      u && (u = st(s, u)),
                      f && (f = st(c, f)),
                    ...
                    !(function (e, r, n) {
                      ...
                      ft("Cannot construct " + l + " due to unbound types", [
                        o,
                      ]);
                    }),
                      Ee([e, r, n], o ? [o] : [], function (r) {
                        var n, i;
                        (r = r[0]),
                          (i = o
                            ? (n = r.registeredClass).instancePrototype
                            : We.prototype);
                        var s = me(p, function () {
                            if (Object.getPrototypeOf(this) !== c)
                              throw new Se("Use 'new' to construct " + l);
                            if (void 0 === h.constructor_body)
                              throw new Se(
                          ...
                          c = Object.create(i, { constructor: { value: s } });
                        s.prototype = c;
                        var h = new Be(l, s, c, d, n, a, u, f),
                          v = new it(l, h, !0, !1, !1),
                          y = new it(l + "*", h, !1, !1, !1),
                          m = new it(l + " const*", h, !1, !0, !1);
                        return (
                          (Ge[e] = { pointerType: y, constPointerType: m }),
                          (function (e, r, n) {
                            t.hasOwnProperty(e) ||
                              we("Replacing nonexistant public symbol"),
                            ...
                            (e.registeredClass.constructor_body[t - 1] =
                              function () {
                                arguments.length !== t - 1 &&
                                  ...
                                  (u.length = t);
                                for (var e = 1; e < t; ++e)
                                  u[e] = n[e].toWireType(c, arguments[e - 1]);
                                var i = o.apply(null, u);
                                return le(c), n[0].fromWireType(i);
                              }),
                            []
                          );
                        }),
                  ...
                  c: function (e, t, r, n, o, i, a, s) {
                    ...
                    (t = Ce(t)),
                      ...
                      Ee([], [e], function (e) {
                        var n = (e = e[0]).name + "." + t;
                        function o() {
                          ft("Cannot call " + n + " due to unbound types", u);
                        }
                        ...
                        return (
                          ...
                          (void 0 === f.overloadTable &&
                            ...
                            ? ((o.argCount = r - 2),
                              (o.className = e.name),
                              (c[t] = o))
                            : (He(c, t, n), (c[t].overloadTable[r - 2] = o)),
                          Ee([], u, function (o) {
                            var s = (function (e, t, r, n, o) {
                              ...
                              return function () {
                                ...
                                arguments.length !== f &&
                                  ...
                                  (h[0] = o),
                                  a &&
                                    ((r = t[1].toWireType(d, this)),
                                    (h[1] = r));
                                for (var i = 0; i < f; ++i)
                                  (l[i] = t[i + 2].toWireType(d, arguments[i])),
                                    h.push(l[i]);
                                var u = n.apply(null, h);
                                if (s) le(d);
                                else
                                  for (i = a ? 1 : 2; i < t.length; i++) {
                                    var p = 1 === i ? r : l[i - 2];
                                    null !== t[i].destructorFunction &&
                                      t[i].destructorFunction(p);
                                  }
                    ...
                    ke(e, {
                      ...
                      toWireType: function (e, t) {
                        if ("number" != typeof t && "boolean" != typeof t)
                          throw new TypeError(
                            'Cannot convert "' + gt(t) + '" to ' + this.name
                          );
                        return t;
                      },
                      argPackAdvance: 8,
                      readValueFromPointer: bt(t, n),
                      destructorFunction: null,
                    });
                  },
                  n: function (e, t, r, n, o) {
                    (t = Ce(t)), -1 === o && (o = 4294967295);
                    var i = _e(r),
                      a = function (e) {
                        return e;
                      };
                    ...
                    ke(e, {
                      ...
                      toWireType: function (e, r) {
                        if ("number" != typeof r && "boolean" != typeof r)
                          throw new TypeError(
                            'Cannot convert "' + gt(r) + '" to ' + this.name
                          );
                        if (r < n || r > o)
                          throw new TypeError(
                            'Passing a number "' +
                      ...
                      argPackAdvance: 8,
                      readValueFromPointer: wt(t, i, 0 !== n),
                      destructorFunction: null,
                    });
                  },
                  m: function (e, t, r) {
                    ...
                    ke(e, {
                      ...
                      fromWireType: function (e) {
                        ...
                        if (r)
                          ...
                          var u = new Array(n);
                          for (i = 0; i < n; ++i)
                            u[i] = String.fromCharCode(C[e + 4 + i]);
                          t = u.join("");
                        }
                        return Vt(e), t;
                      },
                      toWireType: function (e, t) {
                        ...
                        else for (a = 0; a < o; ++a) C[i + 4 + a] = t[a];
                        return null !== e && e.push(Vt, i), i;
                      },
                      argPackAdvance: 8,
                      readValueFromPointer: he,
                  ...
                  v: function (e, t, r, n, o, i) {
                    fe[e] = {
                      name: Ce(t),
                      rawConstructor: st(r, n),
                      rawDestructor: st(o, i),
                      fields: [],
                    };
                  },
                  k: function (e, t, r, n, o, i, a, s, u, c) {
                    fe[e].fields.push({
                      fieldName: Ce(t),
                      getterReturnType: r,
                      getter: st(n, o),
                  ...
                  h: function (e, t, r) {
                    (e = Et(e)), (t = _t(t, "emval::as"));
                    var n = [],
                      o = mt(n);
                    return (k[r >> 2] = o), t.toWireType(n, e);
                  },
                  w: function (e, t, r, n) {
                    e = Et(e);
                    for (
                      var o = Tt(t, r), i = new Array(t), a = 0;
                      a < t;
                      ++a
                    ) {
                      var s = o[a];
                      (i[a] = s.readValueFromPointer(n)),
                        (n += s.argPackAdvance);
                    }
                    return mt(e.apply(void 0, i));
                  },
                  ...
                  f: function (e, t, r, n) {
                    (e = kt[e])((t = Et(t)), (r = St(r)), null, n);
                  },
                  a: pt,
                  s: function (e) {
                    return 0 === e ? mt(Pt()) : ((e = St(e)), mt(Pt()[e]));
                  },
                  d: function (e, t) {
                    var r,
                      n,
                    ...
                    return (
                      (r = function (t, r, n, s) {
                        for (var u = 0, c = 0; c < e - 1; ++c)
                          (a[c] = o[c + 1].readValueFromPointer(s + u)),
                            (u += o[c + 1].argPackAdvance);
                        var f = t[r].apply(t, a);
                        for (c = 0; c < e - 1; ++c)
                          o[c + 1].deleteObject && o[c + 1].deleteObject(a[c]);
                        if (!i.isVoid) return i.toWireType(n, f);
                      }),
                      (n = kt.length),
                      kt.push(r),
                      n
                  ...
                  D: function (e) {
                    return (e = St(e)), mt(t[e]);
                  },
                  e: function (e, t) {
                    return mt((e = Et(e))[(t = Et(t))]);
                  },
                  i: function (e) {
                    e > 4 && (dt[e].refcount += 1);
                  },
                  ...
                  l: function (e, t, r) {
                    (e = Et(e)), (t = Et(t)), (r = Et(r)), (e[t] = r);
                  },
                  j: function (e, t) {
                    return mt(
                      (e = _t(e, "_emval_take_value")).readValueFromPointer(t)
                    );
                  },
                  o: function (e) {
                    return mt(typeof (e = Et(e)));
                  },
                  x: function () {
                    z();
                  },
                  E: function (e, t) {
                    ...
                    if (0 === e) r = Date.now();
                      ...
                      if (1 !== e && 4 !== e)
                        return (n = 28), (k[Yt() >> 2] = n), -1;
                      r = At();
                    }
                    return (
                      (k[t >> 2] = (r / 1e3) | 0),
                      (k[(t + 4) >> 2] = ((r % 1e3) * 1e3 * 1e3) | 0),
                      0
                    );
                  },
                  L: function (e, t, r) {
                    ...
                    for (var r, n, o = 1; o <= 4; o *= 2) {
                      ...
                      if (
                        ...
                        Ot(
                          Math.min(
                            2147483648,
                            ((r = Math.max(16777216, e, i)) % (n = 65536) > 0 &&
                              (r += n - (r % n)),
                            r)
                          )
                        ))
                  ...
                  O: function (e, t) {
                    var r = 0;
                    return (
                      Mt().forEach(function (n, o) {
                        var i = t + r;
                        (k[(e + 4 * o) >> 2] = i),
                          (function (e, t, r) {
                            for (var n = 0; n < e.length; ++n)
                              T[t++ >> 0] = e.charCodeAt(n);
                            r || (T[t >> 0] = 0);
                          })(n, i),
                          (r += n.length + 1);
                      }),
                  ...
                  I: function (e) {
                    ...
                    var t = new Date(
                      ...
                      s = Math.min(a, i);
                    if (r < 0) k[(e + 32) >> 2] = Number(i != a && s == n);
                    else if (r > 0 != (s == n)) {
                      var u = Math.max(a, i),
                        c = r > 0 ? s : u;
                    ...
                    k[(e + 24) >> 2] = t.getDay();
                    var f = ((t.getTime() - o.getTime()) / 864e5) | 0;
                    return (
                      (k[(e + 28) >> 2] = f),
                      (k[e >> 2] = t.getSeconds()),
                      (k[(e + 4) >> 2] = t.getMinutes()),
                      (k[(e + 8) >> 2] = t.getHours()),
                      (k[(e + 12) >> 2] = t.getDate()),
                      (k[(e + 16) >> 2] = t.getMonth()),
                      (t.getTime() / 1e3) | 0
                ...
                Gt =
                        ...
                        (function (e) {
                          if (
                            ...
                            t.monitorRunDependencies &&
                              t.monitorRunDependencies(Y),
                            0 == Y &&
                              (null !== V && (clearInterval(V), (V = null)), q))
                          ) {
                            var r = q;
                            (q = null), r();
                          }
                  ...
                  (t.___wasm_call_ctors = function () {
                    return (Gt = t.___wasm_call_ctors = t.asm.Z).apply(
                      null,
                      arguments
                    );
                  })),
                Ht = (t._malloc = function () {
                  return (Ht = t._malloc = t.asm._).apply(null, arguments);
                }),
                Bt = (t.___getTypeName = function () {
                  return (Bt = t.___getTypeName = t.asm.aa).apply(
                    null,
                    arguments
                  );
                }),
                Yt =
                  ((t.___embind_register_native_and_builtin_types =
                    function () {
                      return (t.___embind_register_native_and_builtin_types =
                        t.asm.ba).apply(null, arguments);
                    }),
                  (t.___errno_location = function () {
                    return (Yt = t.___errno_location = t.asm.ca).apply(
                      null,
                      arguments
                    );
                  })),
                Vt = (t._free = function () {
                  return (Vt = t._free = t.asm.da).apply(null, arguments);
                }),
                qt = (t.__get_tzname = function () {
                  return (qt = t.__get_tzname = t.asm.ea).apply(
                    null,
                    arguments
                  );
                }),
                zt = (t.__get_daylight = function () {
                  return (zt = t.__get_daylight = t.asm.fa).apply(
                    null,
                    arguments
                  );
                }),
                Kt = (t.__get_timezone = function () {
                  return (Kt = t.__get_timezone = t.asm.ga).apply(
                    null,
                    arguments
                  );
                });
              ...
              if (
                ((t.dynCall_vij = function () {
                  return (t.dynCall_vij = t.asm.ha).apply(null, arguments);
                }),
                (t.dynCall_viiij = function () {
                  return (t.dynCall_viiij = t.asm.ia).apply(null, arguments);
                }),
                (t.dynCall_viji = function () {
                  return (t.dynCall_viji = t.asm.ja).apply(null, arguments);
                }),
                (t.dynCall_ji = function () {
                  return (t.dynCall_ji = t.asm.ka).apply(null, arguments);
                }),
                (t.dynCall_viij = function () {
                  return (t.dynCall_viij = t.asm.la).apply(null, arguments);
                }),
                (t.dynCall_iijiiiii = function () {
                  return (t.dynCall_iijiiiii = t.asm.ma).apply(null, arguments);
                }),
                (t.dynCall_jiii = function () {
                  return (t.dynCall_jiii = t.asm.na).apply(null, arguments);
                }),
                (t.dynCall_vijii = function () {
                  return (t.dynCall_vijii = t.asm.oa).apply(null, arguments);
                }),
                (t.dynCall_jiji = function () {
                  return (t.dynCall_jiji = t.asm.pa).apply(null, arguments);
                }),
                (t.dynCall_iiiiij = function () {
                  return (t.dynCall_iiiiij = t.asm.qa).apply(null, arguments);
                }),
                (t.dynCall_iiiiijj = function () {
                  return (t.dynCall_iiiiijj = t.asm.ra).apply(null, arguments);
                }),
                (t.dynCall_iiiiiijj = function () {
                  return (t.dynCall_iiiiiijj = t.asm.sa).apply(null, arguments);
                }),
                (q = function e() {
                  Ft || Xt(), Ft || (q = e);
                }),
  ...
  function (e, t, r) {
    ...
    var h = (function () {
      function e(e) {
        u()(this, "state", void 0),
          ...
          (this.state = c.Readable),
          (this.queuedChunks = new l()),
      ...
      return (
        (t.read = function () {
          ...
          switch (this.state) {
            case c.Readable:
              return this.queuedChunks.empty()
                ? new f.a(function (e, r) {
                    t.readRequest = { resolve: e, reject: r };
                  })
                : this.queuedChunks.pop();
            case c.Closed:
              return this.queuedChunks.empty()
                ? f.a.resolve(e.DONE_CHUNK)
                : this.queuedChunks.pop();
            case c.Errored:
              return f.a.reject(this.storedError);
          }
        }),
        (t.cancel = function () {
          ...
          switch (this.state) {
            case c.Readable:
              (this.state = c.Errored),
                ...
                this.readRequest &&
                  (this.readRequest.reject(e), (this.readRequest = null));
          }
        }),
        (t.write = function (e) {
          switch (this.state) {
            case c.Readable:
              var t = { done: !1, value: e };
              this.readRequest
                ? (this.readRequest.resolve(t), (this.readRequest = null))
                : this.queuedChunks.push(f.a.resolve(t));
          }
        }),
        (t.close = function () {
          switch (this.state) {
            case c.Readable:
              this.readRequest &&
                (this.readRequest.resolve(e.DONE_CHUNK),
                (this.readRequest = null)),
                (this.state = c.Closed);
          }
        }),
    ...
    u()(h, "DONE_CHUNK", { done: !0, value: void 0 });
    var d = (function () {
        function e(e, t) {
          u()(this, "reader", void 0),
            (this.reader = new h(e.abort.bind(e))),
            ...
            switch (((e.responseType = t), t)) {
              case "moz-chunked-arraybuffer":
                e.addEventListener("progress", function () {
                  ...
                  e.addEventListener(
                    "load",
                    this.reader.close.bind(this.reader)
                  );
                break;
              case "ms-stream":
                e.addEventListener("readystatechange", function () {
                  if (e.readyState === e.LOADING) {
                    ...
                    (t.onprogress = function () {
                      t.result.byteLength > n &&
                        (r.reader.write(new Uint8Array(t.result, n)),
                        (n = t.result.byteLength));
                    }),
                      (t.onload = r.reader.close.bind(r.reader)),
              ...
              case "arraybuffer":
                e.addEventListener(
                  "progress",
                  this.reader.write.bind(this.reader, new Uint8Array(0))
                ),
                  e.addEventListener("load", function () {
                    e.response && r.reader.write(new Uint8Array(e.response)),
                      r.reader.close();
                  });
            }
          }),
      ...
      p = self.fetch && self.ReadableStream ? self.fetch.bind(self) : y,
      v =
        self.fetch && self.ReadableStream
          ? "arraybuffer"
          : b("moz-chunked-arraybuffer") || b("ms-stream") || "arraybuffer";
    function y(e, t) {
      return (
        void 0 === t && (t = {}),
        new f.a(function (r, n) {
          var o = new XMLHttpRequest();
          for (var i in (o.open(t.method || "GET", e), t.headers))
            t.headers.hasOwnProperty(i) && o.setRequestHeader(i, t.headers[i]);
          "include" === t.credentials && (o.withCredentials = !0);
          var a = new d(o, v);
          o.addEventListener("readystatechange", function e() {
            2 === o.readyState &&
              (o.removeEventListener("readystatechange", e), r(new m(o, a)));
          }),
            t.signal &&
    ...
    var m = function (e, t) {
        u()(this, "body", void 0),
          ...
          (this.headers = new g(e));
      },
      g = (function () {
        function e(e) {
          u()(this, "xhr", void 0), (this.xhr = e);
        }
        return (
    ...
    var w,
      E = (function () {
        ...
        var t = e.prototype;
        return (
          (t.setResponse = function (e) {
            (this.response = e),
              this.pendingAbort &&
                ((this.pendingAbort = !1), this.getReader().cancel());
          }),
          (t.abort = function () {
            this.response
          ...
          (t.readBody = function (e, t) {
            var r = this,
              ...
              o =
                t > 0
                  ? self.setTimeout(function i() {
                      var a = performance.now() - n;
                      a < t && t > 0
                        ? (o = self.setTimeout(i, t - a))
                        : (r.abort(), e.error(!0, "Read response timeout"));
                    }, t)
                  : -1;
            this.getReader()
              .read()
              .then(function t(o) {
                ...
                if (!r.cancelled) {
                  if (!i) {
                    ...
                    return (
                      s &&
                        e.read(r.module.copyUint8ArrayToEmscriptenHeap(a), s),
                      (n = performance.now()),
                      r.getReader().read().then(t)
                    );
                  }
                  e.end();
                }
      ...
      _ = (function () {
        function e() {
          u()(this, "closed", void 0), (this.closed = f.a.resolve());
        }
        var t = e.prototype;
        return (
          (t.read = function () {
            return f.a.resolve({ done: !0 });
          }),
          (t.cancel = function () {
            return f.a.resolve();
          }),
    ...
    var M = (function () {
        function e(e, t, r, n) {
          (this.rawCodec = t),
            (this.isProtected = r),
            (this.onError = n),
            u()(this, "pending", void 0),
            u()(this, "unsubscribers", []),
            u()(this, "srcBuf", void 0),
            u()(this, "blocked", !1),
            (this.srcBuf = e),
            (this.pending = new l()),
            this.unsubscribers.push(D(e, "updateend", this.process.bind(this)));
        }
        var t = e.prototype;
        return (
          (t.abort = function () {
      ...
      $ = (function () {
        function e(e, t, r) {
          (this.mediaSource = e),
            (this.onEnded = t),
            (this.onError = r),
            u()(this, "sourceBuffers", Object.create(null)),
            u()(this, "unsubscribers", []),
            this.unsubscribers.push(D(e, "sourceended", t));
        }
        (e.isSupported = function () {
          return void 0 !== self.MediaSource;
        }),
          (e.isSupportedInWorker = function () {
            return e.isSupported() && MediaSource.canConstructInDedicatedWorker;
          }),
          (e.create = function (t, r) {
            var n = new MediaSource(),
              o = new Promise(function (o, i) {
                var a = D(n, "sourceopen", function () {
                  "open" === n.readyState
                    ? (o(new e(n, t, r)), a())
                    : i("The MediaSource was closed upon opening");
                });
              });
            return { objectURL: URL.createObjectURL(n), sink: o };
          });
        var t = e.prototype;
        return (
          (t.addTrack = function (e, t, r) {
            var n = this.mediaSource,
              o = this.sourceBuffers;
            if (o[e]) return o[e].buffer;
            try {
              var i = n.addSourceBuffer("video/mp4;" + t);
              return (o[e] = new M(i, t, r, this.handleError.bind(this))), i;
            } catch (e) {
          ...
          (t.remove = function (e, t) {
            for (
              var r = this.sourceBuffers, n = 0, o = Object.keys(r);
              n < o.length;
              n++
            ) {
              r[o[n]].remove(e, t);
          ...
          (t.handleError = function (e, t) {
            var r = e.code || 102,
              n = 102;
            "NotSupportedError" === e.name && (n = r = 4),
              this.onError(n, r, e.message, t);
          }),
          (t.destroySourceBuffers = function () {
            for (
              var e = this.mediaSource, t = e.sourceBuffers, r = 0;
              r < t.length;
              r++
            )
              try {
                e.removeSourceBuffer(t[r]);
              } catch (e) {
                this.handleError(e, !1);
              }
            for (
              var n = 0, o = Object.keys(this.sourceBuffers);
              n < o.length;
              n++
            ) {
              var i = o[n];
              this.sourceBuffers[i].destroy();
            }
      ...
      N = (function (e) {
        function t(t, r) {
          var n;
          return (
            ((n = e.call(this) || this).sendMessageToClient = t),
            (n.sendMessageToCore = r),
            u()(P()(n), "mseSink", void 0),
            u()(P()(n), "awaitSink", void 0),
            u()(P()(n), "sendRPC", void 0),
            u()(P()(n), "mseInWorkersEnabled", !1),
            u()(P()(n), "nativeControlsEnabled", !1),
            (n.sendRPC = t.bind(P()(n), a.MEDIA_SINK_RPC)),
            (n.awaitSink = void 0),
            n
          );
        }
        ...
        return (
            ...
            if (
              ...
              if (!n && !r) {
                ...
                this.sendMessageToClient(
                  a.CONFIGURE,
                  C()({}, I, { mode: "mse-worker", path: o.objectURL })
                ),
                  (this.awaitSink = new f.a(function (e, r) {
                    o.sink
                      .then(function (r) {
                        (t.mseSink = r),
                          t.onSourceDurationChanged(1 << 30),
                          t.mseSink.setLiveSeekableRange(0, 1 << 30),
                          e();
                      })
                      .catch(function (e) {
                        t.sendMessageToCore("onClientSinkError", [
                          4,
                          4,
                          e.toString(),
                        ]),
              ...
              this.invoke({ name: "addTrack", arg: C()({}, I, e) });
            } else this.sendMessageToClient(a.CONFIGURE, e);
          }),
          (r.addTrack = function (e) {
            var t = e.trackID,
              r = e.codec,
              n = e.isProtected;
            this.mseSink.addTrack(t, r, n);
          }),
          ...
          (r.setTimestampOffset = function (e) {
            var t = e.trackID,
              r = e.offset;
            this.mseSink.setTimestampOffset(t, r);
          }),
          (r.onSourceDurationChanged = function (e) {
            var t = this.mseSink,
              r = t.duration,
              n = (function (e, t, r) {
                var n = e;
          ...
          (r.play = function () {
            ...
            this.mseSink.scheduleUpdate().then(function () {
              return e.sendRPC({ name: "play", arg: void 0 });
            });
          }),
          (r.pause = function () {
            var e = this;
            this.mseSink.scheduleUpdate().then(function () {
              return e.sendRPC({ name: "pause", arg: void 0 });
            });
          }),
          (r.seekTo = function (e) {
            var t = this;
            this.mseSink.scheduleUpdate().then(function () {
              return t.sendRPC({ name: "seekTo", arg: e });
            });
          }),
          (r.setVolume = function (e) {
            this.sendRPC({ name: "setVolume", arg: e });
          }),
          (r.setMuted = function (e) {
            this.sendRPC({ name: "setMuted", arg: e });
          }),
          (r.setPlaybackRate = function (e) {
            this.sendRPC({ name: "setPlaybackRate", arg: e });
          }),
          (r.endOfStream = function () {
            var e = this;
            this.mseSink.scheduleUpdate().then(function () {
              return e.sendRPC({ name: "endOfStream", arg: void 0 });
            });
          }),
          (r.reset = function () {
            this.destroyMSESink(), this.sendMessageToClient(a.RESET);
          }),
          (r.delete = function () {
            this.destroyMSESink(), this.sendMessageToClient(a.DESTROY);
          }),
          (r.setMSEInWorkersEnabled = function (e) {
            this.mseInWorkersEnabled = e;
          }),
          (r.invokeSync = function (e) {
            this[e.name].call(this, e.arg);
          }),
          (r.onMediaSourceError = function (e, t, r, n) {
            var o = [e, t, r];
            n
              ? this.sendMessageToCore("onClientSinkError", o)
              : this.sendMessageToCore("onClientSinkRecoverableError", o);
          }),
          (r.onMediaSourceEnded = function () {
            this.destroyMSESink(),
              this.sendMessageToCore("onClientSinkReset", void 0);
          }),
          (r.destroyMSESink = function () {
            var e = this,
              t = function () {
                e.mseSink.destroy(),
                  (e.awaitSink = void 0),
      ...
      W = (function () {
        function e(e, t) {
          u()(this, "module", void 0),
            u()(this, "webTransport", void 0),
            u()(this, "listener", void 0),
        ...
        var t = e.prototype;
        return (
          (t.connectWebTransport = (function () {
            var e = j()(
                  ...
                  function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          return (
                            (this.webTransport = new WebTransport(
                              t.replace("quic-transport://", "https://")
                            )),
                            this.webTransport.closed
                              .then(function (e) {
                                r.closed ||
                                  ((r.closed = !0),
                                  r.listener.onClosed(e.errorCode, e.reason));
                              })
                              .catch(function (e) {
                                console.warn(e),
                                  r.closed ||
                                    ((r.closed = !0),
                                    r.listener.onError(1, e.message));
                              }),
                            (e.next = 4),
                        ...
                        case 4:
                          return (
                            this.closed || this.listener.onReady(),
                            (e.next = 7),
                            this.setupReceiveStreams()
                          );
                        case 7:
                        case "end":
                          return e.stop();
                      ...
                      switch ((e.prev = e.next)) {
                        case 0:
                          return (
                            (e.prev = 0),
                            (e.next = 3),
                            this.webTransport.createUnidirectionalStream()
                          );
                        case 3:
                          (r = e.sent),
                            this.closed || t.onStreamReceived(r),
                            (e.next = 11);
                          break;
                        case 7:
                          (e.prev = 7),
                            ...
                            console.warn(e.t0),
                            this.closed ||
                              this.listener.onError(1, e.t0.message);
                        case 11:
                        case "end":
                          return e.stop();
                      }
                    ...
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          ...
                          return (e.prev = 1), (e.next = 4), t.close();
                        case 4:
                          e.next = 9;
                          break;
                        case 6:
                          (e.prev = 6),
                            (e.t0 = e.catch(1)),
                            console.error("Error closing writer", e.t0);
                        case 9:
                        case "end":
                          return e.stop();
                      }
          ...
          (t.readDataFromReceiveStream = (function () {
            var e = j()(
              F.a.mark(function e(t, r) {
                var n,
                  o,
                  i,
                  a,
                    ...
                    switch ((e.prev = e.next)) {
                      case 0:
                        (n = !1),
                          t.readingAborted
                            .then(function () {
                              (n = !0), s.closed || r.onStreamClose(0);
                            })
                            .catch(function (e) {
                              console.warn(e),
                                (n = !0),
                                s.closed || r.onStreamClose(1);
                            }),
                          ...
                          (a = function e(t) {
                            var a = t.done,
                              u = t.value;
                            if (n || s.closed) o.cancel();
                            else if (!a) {
                              var c = u.byteLength;
                              if (c > 0) {
                                var f =
                                  s.module.copyUint8ArrayToEmscriptenHeap(u);
                                r.onStreamData(f, c);
                              }
                              o.read().then(e).catch(i);
                            }
                          }),
                          o.read().then(a).catch(i);
                      case 6:
                      case "end":
                        return e.stop();
                    }
          ...
          (t.closeReceiveStream = function (e, t) {
            e.abortReading({ errorCode: t });
          }),
                    ...
                    for (;;)
                      switch ((e.prev = e.next)) {
                        ...
                        case 11:
                          (e.prev = 11),
                            (e.t0 = e.catch(2)),
                            console.error("Writing failed", e.t0);
                        case 14:
                        case "end":
                          return e.stop();
                      }
                  ...
                  function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        ...
                        case 7:
                          this.webTransport.close({ errorCode: t, reason: r }),
                            (e.next = 12);
                          break;
                        case 10:
                ...
                return F.a.wrap(
                  function (e) {
                    for (;;)
                      switch ((e.prev = e.next)) {
                        case 0:
                          (t = this.webTransport.incomingUnidirectionalStreams),
                            (r = t.getReader()),
                            (n = function (e) {
                              console.warn(e),
                                i.closed ||
                                  ((i.closed = !0),
                                  i.listener.onError(1, e.message));
                            }),
                            (o = function e(t) {
                              var o = t.done,
                                a = t.value;
                              i.closed
                                ? r.cancel()
                                : o ||
                                  (i.listener.onStreamReceived(a),
                                  r.read().then(e).catch(n));
                            }),
      ...
      G = (function () {
        function e(e, t, r, n) {
          ...
          u()(this, "id", void 0),
            ...
            (this.port = e),
            (this.module = r),
            (this.playerFactory = function (e) {
              return new o.module.WebMediaPlayer(e, n);
            }),
            (this.player = this.playerFactory(this)),
            this.postMessage(i.INITIALIZED);
        }
        var t = e.prototype;
        return (
          (t.recreatePlayer = function () {
            this.port.postMessage("recreatePlayer"),
              (this.player = this.playerFactory(this));
          }),
          ...
          (t.onClientMessage = function (e, t) {
            this.applyMessageToSink(e, t),
              "function" == typeof this.player[e] &&
                this.player[e].apply(this.player, t);
          }),
          (t.getDecodingInfo = function (e) {
            this.postMessage(a.GET_DECODE_INFO, e);
          }),
          (t.onExperiments = function (e) {
            this.postMessage(a.GET_EXPERIMENTS, e);
          }),
          (t.onSessionData = function (e) {
            this.postMessage(i.SESSION_DATA, { sessionData: e });
          }),
          (t.onStateChanged = function (e) {
            this.postMessage(a.STATE_CHANGED, e);
          }),
          (t.onNetworkUnavailable = function () {
            this.postMessage(i.NETWORK_UNAVAILABLE);
          }),
          (t.onRebuffering = function () {
            this.postMessage(i.REBUFFERING);
          }),
          (t.onQualityChanged = function (e) {
            this.postMessage(i.QUALITY_CHANGED, e);
          }),
          (t.onSeekCompleted = function (e) {
            this.postMessage(i.SEEK_COMPLETED, e);
          }),
          (t.onDurationChanged = function (e) {
            this.postMessage(i.DURATION_CHANGED, e),
          ...
          (t.onJSONMetadata = function (e) {
            ...
            "ID3" in n
              ? ((t = w.ID3), (r = n.ID3))
              : "caption" in n && ((t = w.CAPTION), (r = n.caption)),
              t && this.postMessage(t, r);
          }),
          (t.onMetadata = function (e, t) {
            if (t.buffer) {
              var r = new Uint8Array(t).buffer;
              this.postMessage(i.METADATA, { type: e, data: r }, [r]);
            } else this.postMessage(i.METADATA, { type: e, data: t });
          }),
          (t.onCue = function (e) {
            if ("TextCue" === e.type) this.postMessage(i.TEXT_CUE, e);
            else if ("TextMetadataCue" === e.type) {
              var t = e;
              if (
                (this.postMessage(i.TEXT_METADATA_CUE, e),
                "segmentmetadata" === t.description && t.text)
              )
                try {
                  var r = JSON.parse(t.text);
                  void 0 !== r.stream_offset &&
                    this.postMessage(i.SEGMENT_METADATA, {
                      streamOffset: r.stream_offset,
                    });
                } catch (e) {}
            } else
              "AdCue" === e.type
                ? this.postMessage(i.AD_CUE, e)
                : "StreamSourceCue" === e.type &&
                  this.postMessage(i.STREAM_SOURCE_CUE, e);
          }),
          (t.onError = function (e, t, r, n) {
            this.postMessage(i.ERROR, {
              type: e,
              code: t,
              source: r,
              message: n,
          ...
          (t.onRecoverableError = function (e, t, r, n) {
            this.postMessage(i.RECOVERABLE_ERROR, {
              type: e,
              code: t,
              source: r,
              message: n,
          ...
          (t.onAnalyticsEvent = function (e, t) {
            var r = B(t);
            this.postMessage(i.ANALYTICS_EVENT, { name: e, properties: r });
          }),
          (t.configure = function (e, t, r, n, o) {
          ...
          (t.enqueue = function (e, t) {
            var r = new Uint8Array(t).buffer;
            this.workerSink.invoke(
              { name: "enqueue", arg: { trackID: e, buffer: r } },
              [r]
            );
          }),
          (t.endOfStream = function () {
            this.workerSink.invoke({ name: "endOfStream", arg: void 0 });
          }),
          (t.setTimestampOffset = function (e, t) {
            this.workerSink.invoke({
              name: "setTimestampOffset",
              arg: { trackID: e, offset: t },
            });
          }),
          (t.play = function () {
            this.workerSink.invoke({ name: "play", arg: void 0 });
          }),
          (t.pause = function () {
            this.workerSink.invoke({ name: "pause", arg: void 0 });
          }),
          (t.reset = function () {
          ...
          (t.seekTo = function (e) {
            this.workerSink.invoke({ name: "seekTo", arg: e });
          }),
          (t.setPlaybackRate = function (e) {
            this.workerSink.invoke({ name: "setPlaybackRate", arg: e }),
              this.postMessage(i.PLAYBACK_RATE_CHANGED, e);
          }),
          (t.setVolume = function (e) {
            this.workerSink.invoke({ name: "setVolume", arg: e });
          }),
          (t.addCue = function (e, t, r) {
            this.postMessage(a.ADD_CUE, { id: e, start: t, end: r });
          }),
          (t.getWebTransportProxy = function (e) {
            return new W(this.module, e);
          }),
          (t.onPropertyChanged = function (e, t) {
            this.postMessage(a.PROPERTY_CHANGED, { key: e, value: t });
          }),
          (t.postMessage = function (e, t, r) {
            H(this.port, this.id, e, t, r);
          }),
          (t.setMSEInWorkersEnabled = function (e) {
            this.workerSink.setMSEInWorkersEnabled(e);
          }),
    ...
    function H(e, t, r, n, o) {
      e.postMessage({ id: t, type: r, arg: n }, o);
    }
    function B(e) {
      try {
        return JSON.parse(e);
    ...
    var Y,
      V = r(12).default;
    (Y =
      "undefined" == typeof messageHandler ? self : messageHandler).onmessage =
      function (e) {
        var t = new q(Y);
        (Y.onmessage = function (e) {
          ...
          (function (e, t) {
            ...
            V({
              ...
              sendFetchRequest: function (e, t, n, o) {
                return (function (e, t, r, n, o) {
                  ...
                  "undefined" != typeof AbortController &&
                    ((i = new AbortController()), (n.signal = i.signal));
                  var a = new E(e, i),
                    s = -1;
                  function u() {
                    ...
                    p(r, n)
                      ...
                      .catch(function (e) {
                        a.cancelled ||
                          ...
                          t.error("AbortError" === e.name, e.message));
                      })
                      .then(u, u),
                    function () {
                      return a.cancel();
              ...
              onAbort: function (n) {
                if (r) {
                  var o = r._emscripten_get_callstack_js(24);
                  if (t.showWorkerLogs)
                    return void e.logMessage("error", n + "\n" + o);
                  i(n), i(o);
              ...
              logMessage: function (n, o) {
                if (t.showWorkerLogs) {
                  var a = "log";
                  return (
                    4 & n ? (a = "error") : 2 & n && (a = "warn"),
                    void e.logMessage(a, o)
                  );
                }
              ...
              copyUint8ArrayToEmscriptenHeap:
                ((n = 0),
                (o = 0),
                function (e, t) {
                  void 0 === t && (t = !1);
                  ...
                  return (
                    c > o && (n && s(n), (n = u(c)), (o = c)), a.set(e, n), n
                  );
                }),
            }).then(function (t) {
              (r = t), e.ready(r);
    ...
    var q = (function () {
      ...
      return (
              ...
              try {
                if ("create" === a) {
                  ...
                  return (
                    ...
                    void (
                      !0 === u.testOnly &&
                      ((this.module.recreatePlayer = function () {
                        t.activePlayers[o].recreatePlayer();
                      }),
                      (this.module.getPointer = function () {
                        return (
                          (t.module.skipEvents = !1),
                          t.activePlayers[o].getPointer()
                        );
                      }),
                      (this.module.skipWorkerMessage = function () {
                        t.module.skipEvents = !0;
                      }))
                    )
                  );
                }
                if ("runTests" === a)
                  return (
                    (this.module.collectLogs = !0),
                    (this.module.logList = []),
                    (this.module.cliOptions = s[0]),
                    void this.module._runTests()
                  );
                if (!this.activePlayers[o]) return;
                this.activePlayers[o].onClientMessage(a, s),
                  "delete" === a && (this.activePlayers[o] = null);
              } catch (e) {
                console.warn(e),
                  this.activePlayers[o] &&
                    H(this.port, o, i.WORKER_ERROR, {
                      code: n.GENERIC,
                      source: "worker",
                      message: e.message,
                    });
        ...
        (t.logMessage = function (e, t) {
          H(this.port, 0, a.LOG_MESSAGE, { level: e, message: t });
        }),
        e
      );
    })();
